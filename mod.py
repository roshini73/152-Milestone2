...
class Moderator:
    ...
    YES_KEYWORD = "Y"
    NO_KEYWORD = "N"
    ALL_OPTIONS = [START_KEYWORD, NEXT_KEYWORD, CANCEL_KEYWORD, HELP_KEYWORD, T_KEYWORD, V_KEYWORD, YES_KEYWORD, NO_KEYWORD]
    ...
    async def handle_message(self, message):
        ...
        elif self.state == State.AWAITING_TERRORISM and message.content == self.NO_KEYWORD:
            self.state = State.MODERATION_COMPLETE
        ...
        elif self.state == State.AWAITING_SOURCE and message.content == self.V_KEYWORD:
        ...
        elif self.state == State.AWAITING_AID and message.content == self.NO_KEYWORD:
            self.state = State.MODERATION_COMPLETE
            self.removed = True
